...
10. the whole real archive: redacted, then audited by the independent checker
    indexed 875 sessions, 52623 turns from 770 files
      kinds: tool_input=15307, tool_output=14265, assistant_text=9520, meta=5770, thinking=3492, user_request=3461, error=808
      skipped: 31808 attachments, 2181 encrypted reasoning blobs, 0 unparseable lines, 7173 empty turns
      built in 3.2s
  ok    real archive indexed
  ok    audited 52623 real turns, 0 finding(s)

11. negative control for check 10: the same audit over UNREDACTED text must fail
5330 findings in the first 4000 unredacted turns, 0 after redaction
